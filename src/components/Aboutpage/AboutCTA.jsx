...
const AboutCTA = () => {
    ...
    return (
        <section ref={sectionRef} className="bg-white dark:bg-[#1E293B] relative transition-colors duration-700 border-t border-gray-100 dark:border-gray-700/50 overflow-hidden py-16 lg:py-24">
            ...
            <div className="absolute top-1/2 left-1/4 w-[400px] h-[400px] bg-rose-600/5 rounded-full blur-[120px] animate-pulse pointer-events-none" />
                    ...
                    <div className="lg:col-span-7">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                <div className="h-[1px] w-8 bg-rose-600" />
                                <span className={`text-[10px] font-black tracking-[0.4em] uppercase text-rose-700 dark:text-rose-500 ${headingFont}`}>
                            ...
                            <h2 className={`${headingFont} text-4xl lg:text-6xl font-black text-gray-900 dark:text-white leading-[0.95] tracking-tight mb-8`}>
                                ARCHITECT <br />
                                YOUR <br />
                                <span className="text-rose-600 italic font-serif">PROFESSIONAL</span> LEGACY
                            </h2>
                    ...
                    <div className="lg:col-span-5 pt-8 lg:pt-16">
                        <div className="flex flex-col gap-8">
                            {[
                                ...
                                >
                                    <div className="w-12 h-12 lg:w-14 lg:h-14 shrink-0 rounded-xl bg-gray-50 dark:bg-white/[0.03] flex items-center justify-center group-hover:bg-rose-600 transition-all duration-500 shadow-sm border border-gray-100 dark:border-white/5">
                                        <item.icon size={22} className="text-rose-700 dark:text-rose-600 group-hover:text-black transition-colors" />
                                    </div>
                                    <div className="flex flex-col gap-1.5">
                                        <span className={`text-[9px] font-black tracking-[0.3em] text-gray-400 group-hover:text-rose-700 dark:group-hover:text-rose-500 transition-colors uppercase ${headingFont}`}>
                                            {item.label}
                                        </span>
