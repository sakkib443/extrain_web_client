      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4 flex-1">
          <div className="relative max-w-md w-full">
            ...
            <input
              type="text"
              placeholder="Search websites, software, orders..."
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`relative p-2.5 rounded-xl transition-all duration-300 overflow-hidden group ${isDark
              ? 'bg-gradient-to-br from-[#FD9A00] to-[#2dd4bf] text-white shadow-lg shadow-[#FD9A00]/30 hover:shadow-[#FD9A00]/50'
              : 'bg-gradient-to-br from-[#FD9A00] to-orange-500 text-white shadow-lg shadow-[#FD9A00]/30 hover:shadow-[#FD9A00]/50'
              }`}
              ...
              <div className={`absolute right-0 top-full mt-2 w-56 rounded-2xl shadow-2xl border overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 ${isDark
                ...
                <div className={`p-4 border-b ${isDark
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#FD9A00] to-[#2dd4bf] flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-[#FD9A00]/25">
                      {user?.firstName?.[0] || 'A'}
                    </div>
                    <div>
                      ...
                      <p className={`text-xs ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                        {user?.email || 'admin@extrainweb.com'}
                      </p>
                    </div>
                  </div>
                </div>
