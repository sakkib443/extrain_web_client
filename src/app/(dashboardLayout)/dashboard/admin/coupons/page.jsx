...
const CouponsPage = () => {
    ...
    const handleEdit = (coupon) => {
        ...
        setFormData({
            ...
            // Installment Settings
            installmentEnabled: coupon.installmentEnabled || false,
            installmentCount: coupon.installmentCount || 3,
            installmentIntervalDays: coupon.installmentIntervalDays || 30,
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-rose-600 to-emerald-500 text-white rounded-xl font-semibold shadow-lg shadow-rose-600/25 hover:shadow-xl transition-all"
                    >
                        <LuPlus size={18} />
                        Create Coupon
                    </button>
            ...
            <div className={`relative max-w-md ${isDark ? 'text-white' : 'text-gray-900'}`}>
                ...
                <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 rounded-xl border ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-gray-200'} focus:ring-2 focus:ring-rose-600`}
                />
            </div>
            ...
            {loading ? (
                <div className="flex justify-center py-20">
                    <div className="w-10 h-10 border-4 border-rose-600/30 border-t-rose-600 rounded-full animate-spin"></div>
                </div>
                    ...
                    {filteredCoupons.map((coupon) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-rose-600 to-emerald-500 flex items-center justify-center text-white">
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={() => copyCode(coupon.code)} className="text-gray-400 hover:text-rose-600">
                                            <LuCopy size={14} />
                                        </button>
                                    </div>
                            ...
                            <div className={`space-y-2 text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>
                                ...
                                {coupon.installmentEnabled && (
                                    <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-purple-100 text-purple-700 rounded text-xs font-semibold">
                                        💳 {coupon.installmentCount}x Installments
                                    </div>
                                )}
                                <div className="flex items-center gap-2">
                                    <LuCalendar size={14} />
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className={`relative w-full max-w-xl max-h-[90vh] overflow-y-auto rounded-3xl ${isDark ? 'bg-slate-900' : 'bg-white'} p-6 shadow-2xl`}>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-3 rounded-xl bg-rose-600 text-white font-medium hover:bg-rose-700"
                                    >
                                        Generate
                                    </button>
                                </div>
                            ...
                            {/* Installment Settings */}
                            <div className={`p-4 rounded-xl border ${isDark ? 'bg-slate-800/50 border-slate-700' : 'bg-purple-50 border-purple-200'}`}>
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-2">
                                        <span className={`text-sm font-semibold ${isDark ? 'text-white' : 'text-purple-800'}`}>
                                            💳 Enable Installment Payment
                                        </span>
                                    </div>
                                    <button
                                        type="button"
                                        onClick={() => setFormData(prev => ({ ...prev, installmentEnabled: !prev.installmentEnabled }))}
                                        className={`w-12 h-6 rounded-full transition-all ${formData.installmentEnabled ? 'bg-purple-600' : isDark ? 'bg-slate-700' : 'bg-gray-300'}`}
                                    >
                                        <div className={`w-5 h-5 rounded-full bg-white shadow-sm transition-transform ${formData.installmentEnabled ? 'translate-x-6' : 'translate-x-0.5'}`}></div>
                                    </button>
                                </div>
                                ...
                                {formData.installmentEnabled && (
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className={`block text-xs font-medium mb-1 ${isDark ? 'text-gray-400' : 'text-purple-700'}`}>
                                                Number of Installments
                                            </label>
                                            <select
                                                value={formData.installmentCount}
                                                onChange={(e) => setFormData(prev => ({ ...prev, installmentCount: e.target.value }))}
                                                className={`w-full px-3 py-2 rounded-lg border ${isDark ? 'bg-slate-700 border-slate-600 text-white' : 'bg-white border-purple-200'}`}
                                            >
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => setFormData(prev => ({ ...prev, installmentIntervalDays: e.target.value }))}
                                                className={`w-full px-3 py-2 rounded-lg border ${isDark ? 'bg-slate-700 border-slate-600 text-white' : 'bg-white border-purple-200'}`}
                                            >
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    className={`w-12 h-6 rounded-full transition-all ${formData.isActive ? 'bg-rose-600' : isDark ? 'bg-slate-700' : 'bg-gray-300'}`}
                                >
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <button
                                    type="submit"
                                    className="flex-1 py-3 rounded-xl font-medium bg-gradient-to-r from-rose-600 to-emerald-500 text-white hover:shadow-lg"
                                >
