...
const pageGradients = {
    home: 'from-rose-600 to-emerald-500',
...
const PageContentDashboard = () => {
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    <FiLoader className="w-12 h-12 text-rose-600 animate-spin mx-auto" />
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Quick Info */}
            <div className={`p-5 rounded-2xl ${isDark ? 'bg-slate-800/50 border border-slate-700' : 'bg-gradient-to-r from-rose-50 to-emerald-50 border border-rose-100'}`}>
                <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-rose-600 to-emerald-500 rounded-xl flex items-center justify-center shrink-0">
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <FiChevronRight
                                        className={`${isDark ? 'text-gray-600' : 'text-gray-300'} group-hover:text-rose-600 group-hover:translate-x-1 transition-all`}
                                        size={24}
                                    />
                                </div>
