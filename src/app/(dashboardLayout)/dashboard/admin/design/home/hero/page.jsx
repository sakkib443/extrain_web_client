        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    <div className="w-12 h-12 border-4 border-rose-600/30 border-t-rose-600 rounded-full animate-spin mx-auto"></div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-rose-600 to-emerald-500 text-white rounded-xl font-semibold shadow-lg shadow-rose-600/25 hover:shadow-xl hover:shadow-rose-600/30 transition-all disabled:opacity-50"
                    >
                        <LuSave size={18} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className={`p-6 rounded-2xl ${isDark ? 'bg-slate-800/50 border border-slate-700' : 'bg-white border border-gray-200'}`}>
                    <div className="flex items-center gap-3 mb-5">
                        <div className="w-10 h-10 bg-gradient-to-br from-rose-600 to-emerald-500 rounded-xl flex items-center justify-center">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full mt-1 px-4 py-3 rounded-xl ${isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:ring-2 focus:ring-rose-600 focus:border-transparent`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full mt-1 px-4 py-3 rounded-xl ${isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:ring-2 focus:ring-rose-600 focus:border-transparent hind-siliguri`}
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full mt-1 px-4 py-3 rounded-xl ${isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:ring-2 focus:ring-rose-600 focus:border-transparent text-lg font-semibold`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full mt-1 px-4 py-3 rounded-xl ${isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:ring-2 focus:ring-rose-600 focus:border-transparent text-lg font-semibold hind-siliguri`}
                ...
                <div className={`p-6 rounded-2xl ${isDark ? 'bg-slate-800/50 border border-slate-700' : 'bg-white border border-gray-200'}`}>
                    <div className="flex items-center justify-between mb-5">
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 px-3 py-1.5 bg-rose-600/10 text-rose-700 rounded-lg text-sm font-medium hover:bg-rose-600/20 transition-colors"
                        >
                            <LuPlus size={16} /> Add
                        </button>
                    </div>
                        ...
                        {heroContent.dynamicTexts?.map((text, index) => (
                            <div key={index} className="flex gap-2">
                                <input
                                    ...
                                    className={`flex-1 px-4 py-2.5 rounded-lg ${isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:ring-2 focus:ring-rose-600 focus:border-transparent`}
                        ...
                        {heroContent.dynamicTextsBn?.map((text, index) => (
                            <div key={index} className="flex gap-2">
                                <input
                                    ...
                                    className={`flex-1 px-4 py-2.5 rounded-lg ${isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:ring-2 focus:ring-rose-600 focus:border-transparent hind-siliguri`}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full mt-1 px-4 py-3 rounded-xl ${isDark ? 'bg-slate-700 text-white border-slate-600' : 'bg-gray-50 text-gray-900 border-gray-200'} border focus:ring-2 focus:ring-rose-600 focus:border-transparent font-bold text-rose-700`}
                                placeholder="e.g., Extrain Web"
                            />
                        </div>
                    </div>
                </div>
