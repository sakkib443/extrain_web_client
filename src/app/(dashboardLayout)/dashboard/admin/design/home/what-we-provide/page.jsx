    ...
    const InputField = ({ label, value, onChange, placeholder }) => (
        <div>
            ...
            <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-rose-600 focus:border-transparent transition-all"
            />
        </div>
    );
        ...
        return (
            <div className="flex items-center justify-center min-h-[60vh]">
                <div className="text-center">
                    <FiRefreshCw className="w-12 h-12 text-rose-600 animate-spin mx-auto" />
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="flex items-center gap-2 px-6 py-2 rounded-xl bg-gradient-to-r from-rose-600 to-cyan-500 text-white font-medium hover:shadow-lg transition-all disabled:opacity-50"
                    >
                        <FiSave size={18} />
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                        onClick={addFeature}
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-rose-600/10 text-rose-600 hover:bg-rose-600/20 transition-all"
                    >
                        <FiPlus size={18} />
                        Add Feature
                    </button>
