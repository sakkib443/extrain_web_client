...
const AboutFeaturesDesignPage = () => {
    ...
    if (loading) return <div className="flex items-center justify-center min-h-[60vh]"><FiRefreshCw className="w-12 h-12 text-rose-600 animate-spin" /></div>;
        ...
        <div className="p-6 max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex gap-3">
                    ...
                    <button onClick={handleSave} disabled={saving} className="flex items-center gap-2 px-6 py-2 rounded-xl bg-gradient-to-r from-rose-600 to-cyan-500 text-white disabled:opacity-50">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button onClick={addFeature} className="flex items-center gap-2 px-4 py-2 bg-rose-600/10 text-rose-600 rounded-xl"><FiPlus /> Add Feature</button>
                </div>
