...
const ReportsPage = () => {
    ...
    const reportTypes = [
        ...
        },
        {
            ...
            icon: FiShoppingBag,
            color: 'from-emerald-500 to-rose-700',
    ...
    const generatePDF = (type, customOptions = null) => {
        ...
        try {
            ...
            const fileName = type === 'custom'
                ? `Extrain Web_Custom_Report_${options.dateFrom}_to_${options.dateTo}.pdf`
                : `Extrain Web_${type}_Report_${new Date().toISOString().split('T')[0]}.pdf`;
