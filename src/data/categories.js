        ...
        pricing: [
            {
                ...
                features: [
                    ...
                    "100% mobile-friendly custom design",
                    "Rocket-fast & hack-proof website",
                    "Free SEO & speed optimization",
                    "bKash, Nagad, Rocket & COD payment",
                    "Auto order system + instant notification",
                    "WhatsApp / Messenger live chat",
                    "Customer order tracking dashboard",
                    "Admin dashboard — no coding needed",
                    "Product upload & stock management",
                    "Daily & monthly revenue reports",
                    "Lifetime technical support",
                ],
                featuresBn: [
                    "Next.js ও Node.js দিয়ে তৈরি",
                    "১০০% মোবাইল-ফ্রেন্ডলি কাস্টম ডিজাইন",
                    "রকেট স্পিড ও হ্যাক-প্রুফ ওয়েবসাইট",
                    "ফ্রি এসইও ও স্পিড অপটিমাইজেশন",
                    "বিকাশ, নগদ, রকেট ও COD পেমেন্ট",
                    "অটো অর্ডার সিস্টেম + ইনস্ট্যান্ট নোটিফিকেশন",
                    "WhatsApp / Messenger লাইভ চ্যাট",
                    "কাস্টমার অর্ডার ট্র্যাকিং ড্যাশবোর্ড",
                    "অ্যাডমিন ড্যাশবোর্ড — কোডিং ছাড়াই",
                    "প্রোডাক্ট আপলোড ও স্টক ম্যানেজমেন্ট",
                    "ডেইলি ও মান্থলি রেভিনিউ রিপোর্ট",
