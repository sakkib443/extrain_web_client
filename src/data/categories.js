    ...
    "learning-management": {
        ...
        pricing: [
            ...
            },
            {
                ...
                summary: "For coaching centers & academies", summaryBn: "কোচিং সেন্টার ও একাডেমির জন্য",
                features: [], featuresBn: [],
                featuresRich: [
                    {
                        title: "Next.js & Node.js Technology",
                        titleBn: "Next.js ও Node.js প্রযুক্তি",
                        desc: "Same powerful modern tech, tuned for higher traffic",
                        descBn: "একই শক্তিশালী আধুনিক প্রযুক্তি, বেশি ট্রাফিকের জন্য অপটিমাইজড",
                    },
                    {
                        title: "National Skill Certified Developer",
                        titleBn: "ন্যাশনাল স্কিল সার্টিফাইড ডেভেলপার",
                        desc: "Built & secured by a nationally certified developer",
                        descBn: "ন্যাশনাল স্কিল সার্টিফাইড ডেভেলপারের তৈরি ও নিরাপদ",
                    },
                    {
                        title: "Premium Custom Design",
                        titleBn: "প্রিমিয়াম কাস্টম ডিজাইন",
                        desc: "Tailored design — a step above the Basic theme",
                        descBn: "বেসিকের থিমের চেয়ে এক ধাপ উপরে — কাস্টম ডিজাইন",
                    },
                    {
                        title: "Up to 50 Courses",
                        titleBn: "সর্বোচ্চ ৫০টি কোর্স",
                        desc: "Far bigger catalog than Basic's 10 courses",
                        descBn: "বেসিকের ১০টির চেয়ে অনেক বড় ক্যাটালগ",
                    },
                    {
                        title: "Advanced Course Category + Sub-categories",
                        titleBn: "অ্যাডভান্সড ক্যাটাগরি ও সাব-ক্যাটাগরি",
                        desc: "Organize courses in categories and sub-categories",
                        descBn: "ক্যাটাগরি ও সাব-ক্যাটাগরিতে কোর্স সাজান",
                    },
                    {
                        title: "Rich Course & Lesson Pages",
                        titleBn: "বিস্তারিত কোর্স ও লেসন পেজ",
                        desc: "Full curriculum, lesson list and course details",
                        descBn: "সম্পূর্ণ কারিকুলাম, লেসন লিস্ট ও কোর্স ডিটেলস",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        titleBn: "ব্যাচ ম্যানেজমেন্ট",
                        desc: "Create batches and enroll students batch-wise",
                        descBn: "ব্যাচ তৈরি করে ব্যাচ অনুযায়ী শিক্ষার্থী ভর্তি করুন",
                    },
                    {
                        title: "Student Attendance",
                        titleBn: "স্টুডেন্ট অ্যাটেনডেন্স",
                        desc: "Track who attended every class or batch",
                        descBn: "কোন ক্লাসে কে উপস্থিত ছিল — সব ট্র্যাক করুন",
                    },
                    {
                        title: "Assignment System",
                        titleBn: "অ্যাসাইনমেন্ট সিস্টেম",
                        desc: "Students submit assignments, instructors grade them",
                        descBn: "শিক্ষার্থী অ্যাসাইনমেন্ট জমা দেবে, ইন্সট্রাক্টর গ্রেড করবে",
                    },
                    {
                        title: "Quiz & Exam + Auto-Grading",
                        titleBn: "কুইজ ও পরীক্ষা + অটো-গ্রেডিং",
                        desc: "Online exams that grade themselves instantly",
                        descBn: "অনলাইন পরীক্ষা যা নিজে থেকেই সাথে সাথে গ্রেড হয়",
                    },
                    {
                        title: "Auto Certificate on Completion",
                        titleBn: "অটো সার্টিফিকেট",
                        desc: "Branded certificate issued automatically when done",
                        descBn: "কোর্স শেষে অটো ব্র্যান্ডেড সার্টিফিকেট",
                    },
                    {
                        title: "AI Chat Bot",
                        titleBn: "এআই চ্যাটবট",
                        desc: "24/7 AI assistant answers students automatically",
                        descBn: "২৪ ঘণ্টা এআই অ্যাসিস্ট্যান্ট অটো উত্তর দেবে",
                    },
                    {
                        title: "Instructor / Mentor Dashboard",
                        titleBn: "ইন্সট্রাক্টর ও মেন্টর ড্যাশবোর্ড",
                        desc: "Each mentor manages their own courses & students",
                        descBn: "প্রতিটা মেন্টর নিজের কোর্স ও শিক্ষার্থী ম্যানেজ করবে",
                    },
                    {
                        title: "Student Dashboard + Progress",
                        titleBn: "স্টুডেন্ট ড্যাশবোর্ড + প্রোগ্রেস",
                        desc: "Students see courses, progress, attendance & certificates",
                        descBn: "শিক্ষার্থী কোর্স, প্রোগ্রেস, অ্যাটেনডেন্স ও সার্টিফিকেট দেখবে",
                    },
                    {
                        title: "Advanced Admin Dashboard",
                        titleBn: "অ্যাডভান্সড অ্যাডমিন ড্যাশবোর্ড",
                        desc: "Deeper control and reports than Basic",
                        descBn: "বেসিকের চেয়ে গভীর নিয়ন্ত্রণ ও রিপোর্ট",
                    },
                    {
                        title: "bKash & Nagad Payment + Verification",
                        titleBn: "বিকাশ ও নগদ পেমেন্ট + ভেরিফিকেশন",
                        desc: "Manual + online bKash & Nagad with easy verification",
                        descBn: "ম্যানুয়াল + অনলাইন বিকাশ ও নগদ, সহজ ভেরিফিকেশন",
                    },
                    {
                        title: "Review, Rating + Cart",
                        titleBn: "রিভিউ, রেটিং ও কার্ট",
                        desc: "Reviews, star ratings and smart add-to-cart",
                        descBn: "রিভিউ, স্টার রেটিং ও স্মার্ট কার্ট",
                    },
                    {
                    ...
                    },
                    {
                        ...
                        desc: "Content marketing to bring free Google traffic",
                        descBn: "গুগল থেকে ফ্রি ভিজিটর আনতে কন্টেন্ট মার্কেটিং",
                    },
                    {
                        title: "All Essential Pages",
                        titleBn: "সব দরকারি পেজ",
                    ...
                    {
                        title: "3 Months Priority Support",
                        titleBn: "৩ মাস প্রায়োরিটি সাপোর্ট",
                        desc: "Priority technical help for 90 days after launch",
                        descBn: "লাইভ হওয়ার পর ৯০ দিন প্রায়োরিটি সাপোর্ট",
                    },
                ],
                popular: true,
            },
            {
                ...
                dominoChain: {
                    ...
                    steps: ["Enroll", "Payment", "Access", "Quiz", "Certificate", "ID Verify", "Notify"],
                    stepsBn: ["এনরোল", "পেমেন্ট", "এক্সেস", "কুইজ", "সার্টিফিকেট", "আইডি ভেরিফাই", "নোটিফাই"],
                },
                featuresRich: [
                    {
                        title: "Next.js & Node.js Technology",
                        titleBn: "Next.js ও Node.js প্রযুক্তি",
                        desc: "Enterprise-grade modern tech for heavy traffic",
                        descBn: "ভারী ট্রাফিকের জন্য এন্টারপ্রাইজ-গ্রেড আধুনিক প্রযুক্তি",
                    },
                    {
                        title: "National Skill Certified Developer",
                        titleBn: "ন্যাশনাল স্কিল সার্টিফাইড ডেভেলপার",
                    ...
                    },
                    {
                        ...
                        titleBn: "কাস্টম ফিচার (চাহিদা অনুযায়ী)",
                        desc: "Any feature built exactly to your requirements",
                        descBn: "আপনার রিকোয়ারমেন্ট অনুযায়ী যেকোনো কাস্টম ফিচার যোগ",
                    },
                    {
                    ...
                    {
                        title: "Advanced Category + Sub-categories",
                        titleBn: "অ্যাডভান্সড ক্যাটাগরি ও সাব-ক্যাটাগরি",
                        desc: "Unlimited categories and sub-categories",
                        descBn: "আনলিমিটেড ক্যাটাগরি ও সাব-ক্যাটাগরি",
                    },
                    {
                        title: "Rich Course & Lesson Pages",
                        titleBn: "বিস্তারিত কোর্স ও লেসন পেজ",
                        desc: "Full curriculum, lessons and course details",
                        descBn: "সম্পূর্ণ কারিকুলাম, লেসন ও কোর্স ডিটেলস",
                    },
                    {
                        title: "Secure Video Hosting",
                        titleBn: "সিকিউর ভিডিও হোস্টিং",
                    ...
                    {
                        title: "Certificate & ID Card Verification",
                        titleBn: "সার্টিফিকেট ও আইডি কার্ড ভেরিফিকেশন",
                        desc: "Public page to verify any certificate or ID card by ID/QR",
                        descBn: "আইডি/QR দিয়ে যেকোনো সার্টিফিকেট বা আইডি কার্ড ভেরিফাই করার পাবলিক পেজ",
                    },
                    {
                        title: "AI Chat Bot",
                        titleBn: "এআই চ্যাটবট",
                    ...
                    {
                        title: "Multi-Instructor + Mentor Dashboard",
                        titleBn: "মাল্টি-ইন্সট্রাক্টর ও মেন্টর ড্যাশবোর্ড",
                        desc: "Unlimited instructors, each with their own panel",
                        descBn: "আনলিমিটেড ইন্সট্রাক্টর, প্রত্যেকের আলাদা প্যানেল",
                    },
                    {
                        title: "Student Dashboard + Progress",
                        titleBn: "স্টুডেন্ট ড্যাশবোর্ড + প্রোগ্রেস",
                        desc: "Courses, progress, attendance & certificates in one place",
                        descBn: "কোর্স, প্রোগ্রেস, অ্যাটেনডেন্স ও সার্টিফিকেট — এক জায়গায়",
                    },
                    {
                        title: "Enterprise Admin Dashboard",
                        titleBn: "এন্টারপ্রাইজ অ্যাডমিন ড্যাশবোর্ড",
                        desc: "Total control over the entire platform",
                    ...
                    {
                        title: "Payment Due & Installment Tracking",
                        titleBn: "পেমেন্ট ডিউ ও ইনস্টলমেন্ট ট্র্যাকিং",
                        desc: "Track pending dues and installment payments easily",
                        descBn: "বাকি পেমেন্ট ও কিস্তি সহজে ট্র্যাক করুন",
                    },
                    {
                        title: "Smart Notifications",
                        titleBn: "স্মার্ট নোটিফিকেশন",
                        desc: "Auto SMS, Email & Push notifications on every event",
                        descBn: "প্রতিটা ইভেন্টে অটো SMS, ইমেইল ও পুশ নোটিফিকেশন",
                    },
                    {
                        title: "Email Support System",
                        titleBn: "ইমেইল সাপোর্ট সিস্টেম",
                        desc: "Built-in email support & ticket system for students",
                        descBn: "শিক্ষার্থীদের জন্য বিল্ট-ইন ইমেইল সাপোর্ট ও টিকেট সিস্টেম",
                    },
                    {
                        title: "Review, Rating & Cart",
                        titleBn: "রিভিউ, রেটিং ও কার্ট",
                    ...
                    },
                    {
                        title: "1 Year Priority Support",
                        titleBn: "১ বছর প্রায়োরিটি সাপোর্ট",
                        desc: "Dedicated VIP support via phone, email & WhatsApp",
                        descBn: "ফোন, ইমেইল ও WhatsApp-এ ডেডিকেটেড VIP সাপোর্ট",
                    },
                ],
                popular: false,
            },
