...
export const CATEGORIES = {
    ecommerce: {
        ...
        pricing: [
            {
                name: "Basic", nameBn: "বেসিক", price: 15000,
                summary: "For small shops getting started", summaryBn: "ছোট দোকানের শুরুর জন্য",
                features: ["Up to 50 products", "Mobile-responsive design", "bKash & Nagad payment", "Cash on Delivery (COD)", "Product search & categories", "Order form + WhatsApp order", "Basic SEO setup", "1 month free support"],
                featuresBn: ["সর্বোচ্চ ৫০টি প্রোডাক্ট", "মোবাইল-রেসপন্সিভ ডিজাইন", "বিকাশ ও নগদ পেমেন্ট", "ক্যাশ অন ডেলিভারি (COD)", "প্রোডাক্ট সার্চ ও ক্যাটাগরি", "অর্ডার ফর্ম + হোয়াটসঅ্যাপ অর্ডার", "বেসিক এসইও সেটআপ", "১ মাস ফ্রি সাপোর্ট"],
                popular: false,
            },
            {
